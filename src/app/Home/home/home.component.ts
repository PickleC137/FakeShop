...
import { ProductService } from '../../service/data.service';
...
export class HomeComponent implements OnInit {
  ...
  addingProduct: boolean = false; // Track if the add product form is visible
  newProduct: any = {}; // New product data
  selectedProduct: any = null; // Property to hold the selected product details
  ...
  getProductDetails(id: number): void {
    this.productService.getProductById(id).subscribe((data: any) => {
      this.selectedProduct = data; // Set the selected product
    });
  }
  ...
  showAddProductForm(): void {
    ...
    this.newProduct = {}; // Clear any existing data
  }
  ...
  cancelAdd(): void {
    ...
    this.newProduct = {}; // Clear form data
  }
